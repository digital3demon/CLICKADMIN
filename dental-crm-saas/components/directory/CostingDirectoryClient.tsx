                ...
                <table className="w-max border-collapse text-left text-sm">
                  <thead>
                    <tr className="border-b border-[var(--card-border)] bg-[var(--surface-muted)]">
                      <th className="sticky left-0 z-20 w-[15rem] shrink-0 border-r border-[var(--card-border)] bg-[var(--surface-muted)] px-3 py-3 text-sm font-semibold text-[var(--app-text)] shadow-[2px_0_6px_-2px_rgba(0,0,0,0.08)]">
                        Позиция
                      </th>
                      <th className="sticky left-[15rem] z-20 w-[9rem] shrink-0 border-r border-[var(--card-border)] bg-[var(--surface-muted)] px-2 py-3 text-sm font-semibold text-[var(--app-text)] shadow-[2px_0_6px_-2px_rgba(0,0,0,0.08)]">
                        Заметка
                      </th>
                      {inputColumns.map((c) => (
                        <th
                          key={c.id}
                          className="w-[7.25rem] max-w-[8rem] shrink-0 whitespace-normal break-words px-2 py-2 text-center text-xs font-semibold leading-snug text-[var(--app-text)]"
                      ...
                      {editor.sharedPools.map((p) => (
                        <th
                          key={p.id}
                          className="w-[7rem] max-w-[7.5rem] shrink-0 whitespace-normal break-words bg-amber-50/80 px-2 py-2 text-center text-xs font-semibold leading-snug text-amber-950 dark:bg-amber-950/25 dark:text-amber-50"
                      ...
                      {computedColumns.map((c) => (
                        <th
                          key={c.id}
                          className="w-[7.25rem] max-w-[8.5rem] shrink-0 whitespace-normal break-words bg-emerald-50/60 px-2 py-2 text-center text-xs font-semibold leading-snug text-emerald-950 dark:bg-emerald-950/25 dark:text-emerald-50"
                          title={c.hint ?? undefined}
                        >
                          = {c.label}
                        </th>
                  ...
                  <tbody>
                    {editor.lines.map((ln) => {
                      ...
                      return (
                        ...
                        >
                          <td className="sticky left-0 z-10 w-[15rem] shrink-0 border-r border-[var(--card-border)] bg-[var(--card-bg)] px-3 py-2.5 text-sm leading-snug">
                          ...
                          <td className="sticky left-[15rem] z-10 w-[9rem] shrink-0 border-r border-[var(--card-border)] bg-[var(--card-bg)] px-2 py-2">
                            <input
                              className="w-full min-w-0 rounded-md border border-transparent bg-transparent px-1.5 py-1.5 text-sm hover:border-[var(--card-border)]"
                          ...
                          {inputColumns.map((c) => (
                            <td key={c.id} className="w-[7.25rem] max-w-[8rem] shrink-0 px-1.5 py-2 text-center align-middle">
                              <input
                                type="number"
                          ...
                          {editor.sharedPools.map((p) => (
                            <td
                              key={p.id}
                              className="w-[7rem] max-w-[7.5rem] shrink-0 bg-amber-50/40 px-1.5 py-2 text-center align-middle dark:bg-amber-950/15"
                            >
                              <input
                                type="number"
                          ...
                          {computedColumns.map((c) => (
                            <td
                              key={c.id}
                              className="w-[7.25rem] max-w-[8.5rem] shrink-0 bg-emerald-50/35 px-2 py-2 text-center align-middle font-mono text-sm tabular-nums text-emerald-950 dark:bg-emerald-950/15 dark:text-emerald-100"
                  ...
                  <tfoot>
                    <tr className="border-t-2 border-[var(--card-border)] bg-[var(--surface-muted)] text-sm font-semibold">
                      <td
                        colSpan={2}
                        className="sticky left-0 z-10 w-[calc(15rem+9rem)] shrink-0 border-r border-[var(--card-border)] bg-[var(--surface-muted)] px-3 py-3 text-base shadow-[2px_0_6px_-2px_rgba(0,0,0,0.08)]"
                      >
                        Итого
                      </td>
                      {inputColumns.map((c) => (
                        <td
                          key={c.id}
                          className="w-[7.25rem] max-w-[8rem] shrink-0 px-1.5 py-3 text-center font-mono text-sm tabular-nums"
                        >
                      ...
                      {editor.sharedPools.map((p) => {
                        ...
                        return (
                          <td
                            key={p.id}
                            className={`w-[7rem] max-w-[7.5rem] shrink-0 px-1.5 py-3 text-center font-mono text-sm tabular-nums ${drift ? "text-amber-800 dark:text-amber-200" : ""}`}
                      ...
                      {computedColumns.map((c) => (
                        <td
                          key={c.id}
                          className="w-[7.25rem] max-w-[8.5rem] shrink-0 px-2 py-3 text-center font-mono text-sm tabular-nums"
                        >
