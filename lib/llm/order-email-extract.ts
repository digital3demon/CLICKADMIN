...
- ПММА/PMMA: временная коронка из каталога прайса (не «индивидуализация десны на РММА», не «немедленная нагрузка» — нагрузку только если явно «немедленная нагрузка»). Вариант «… на винтовой фиксации» из прайса — только при скан-маркерах и/или титановых основаниях, либо явной «винтовой фиксации»; иначе обычная временная коронка из прайса. Не выдумывай название вне каталога. Зубы «12-22, 24» → все FDI, quantity = число зубов. Упомянутые основания (бренд из текста → позиция прайса) — отдельная строка с тем же quantity. Бренд в «… скан-маркер» ≠ титановое основание того же бренда.
