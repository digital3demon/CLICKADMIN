...
export default async function DirectoryAccessPage() {
  ...
  return (
    <ModuleFrame
      ...
      description="Владелец настраивает, какие модули CRM видны каждой роли: заказы, конфигурация, печать этикеток, оформление и др. Сотрудникам с открытой сессией может понадобиться обновить страницу. Владелец всегда с полным доступом."
    >
