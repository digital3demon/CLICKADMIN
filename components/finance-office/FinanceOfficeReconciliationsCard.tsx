...
export function FinanceOfficeReconciliationsCard({
  ...
  return (
    <>
      ...
      >
        <span className="text-[9px] font-bold uppercase leading-tight tracking-wide text-sky-700 dark:text-sky-300 sm:text-[11px]">
          Сверки
        </span>
        <span className="flex items-center justify-center gap-1 sm:gap-1.5">
          ...
          <span
            className="inline-flex min-w-[1.35rem] items-center justify-center rounded-full bg-sky-600 px-1 py-0.5 text-[10px] font-bold tabular-nums text-white sm:min-w-[1.5rem] sm:px-1.5 sm:text-xs"
