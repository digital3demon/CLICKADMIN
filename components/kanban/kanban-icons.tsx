/** Миниатюрные SVG вместо Font Awesome (без CDN). */
...
/** Кладка кирпича — кнопка «заблокировать карточку». */
export function IconBrick({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="16"
...
/** Цепочка ссылки — «поделиться» / копировать URL. */
