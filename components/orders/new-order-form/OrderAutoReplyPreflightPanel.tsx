...
export function OrderAutoReplyPreflightPanel({
  ...
  }, [sendReply, subject, html, canSendReply, loading, hint, onStateChange, sourceEmail]);
          ...
          <>
            ...
            <div>
              ...
              <textarea
                ...
                className="min-h-[12rem] w-full resize-y rounded-md border border-[var(--input-border)] bg-[var(--card-bg)] px-2.5 py-2 font-mono text-xs text-[var(--app-text)] shadow-sm outline-none focus:border-[var(--sidebar-blue)] focus:ring-1 focus:ring-[var(--sidebar-blue)] disabled:opacity-50"
