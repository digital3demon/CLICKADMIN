                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {row.attachments.map((a, ai) => (
                          <button
                            ...
                            className="block overflow-hidden rounded border border-[var(--card-border)] outline-none ring-offset-2 focus-visible:ring-2 focus-visible:ring-[var(--sidebar-blue)]"
                            onClick={() =>
                              setImageViewer({
