...
export function OrdersListStickySearch({
  ...
  return (
    <div className="sticky top-0 z-50 -mx-2 border-b border-[var(--card-border)] bg-[var(--app-bg)] py-2 pe-2 ps-[var(--app-mobile-menu-inset,0px)] shadow-[0_4px_12px_-8px_rgba(0,0,0,0.45)] shell-laptop:hidden">
